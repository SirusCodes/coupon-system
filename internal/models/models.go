...
type Coupon struct {
	...
	ApplicableMedicineIDs []string   `json:"applicable_medicine_ids" gorm:"type:text;column:applicable_medicine_ids" example:"[\"med1\", \"med2\"]"`           // Store as JSON string or comma-separated in DB
	ApplicableCategories  []string   `json:"applicable_categories" gorm:"type:text;column:applicable_categories" example:"[\"category1\", \"category2\"]"`       // Store as JSON string or comma-separated in DB
